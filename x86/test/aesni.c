...
void aes128_enc(int8_t *pt,int8_t *ct){
...
void aes128_dec(int8_t *ct,int8_t *pt){
...
int aes128_self_test(void){
    ...
    for (int i = 0 ; i < 10000 ; i++) {
        ...
        cpu_time += (t1.tv_sec - t0.tv_sec) * 1e9 + (t1.tv_nsec - t0.tv_nsec);
    }
    printf("AES128 key load: %.6f ns\n", cpu_time / 10000);
...
int main()
{
    int ok = aes128_self_test();
    printf("AES128 self test: %d\n", ok);
