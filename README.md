...
* [`Graphene_x86`](graphene_x86/): a portable implementation on commodity hardware tailored for x86 64-bit platforms. It uses OpenSSL and GMP to implement cryptoraphic primitives and finite-field operations, respectively.
